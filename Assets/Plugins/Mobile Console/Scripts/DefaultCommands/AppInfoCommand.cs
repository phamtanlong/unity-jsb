...
namespace MobileConsole
{
    ...
    [ExecutableCommand(name = "System/Crash Game")]
    public class CrashGameCommand : Command
    {
        public override void Execute()
        {
            UnityEngine.Debug.LogError("Preparing to crash...");
            //NativeLib.Instance.FatalCrash();
        }
    }
