...
namespace MobileConsole
{
	...
	internal static class LogInitializeOnLoad
	{
		internal const string KEY_PREVENT_AUTO_STARTUP = "MobileConsole_PreventAutoStartup";
		...
		{
            if (LogConsoleSettings.Instance.autoStartup && PlayerPrefs.GetInt(KEY_PREVENT_AUTO_STARTUP, 0) == 0)
            {
