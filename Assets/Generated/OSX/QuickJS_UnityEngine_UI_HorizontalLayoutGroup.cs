...
namespace jsb {
    ...
    [JSBindingAttribute]
    public class QuickJS_UnityEngine_UI_HorizontalLayoutGroup
    {
        ...
        public static JSValue Bind_CalculateLayoutInputHorizontal(JSContext ctx, JSValue this_obj, int argc, JSValue[] argv)
        {
            try
            {
                if (argc == 0)
                {
                    UnityEngine.UI.HorizontalLayoutGroup self;
        ...
        {
            var cls = register.CreateClass("HorizontalLayoutGroup", typeof(UnityEngine.UI.HorizontalLayoutGroup), QuickJS.JSNative.class_private_ctor);
