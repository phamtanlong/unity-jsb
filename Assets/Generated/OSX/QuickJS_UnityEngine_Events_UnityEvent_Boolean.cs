...
namespace jsb {
    ...
    // Type: UnityEngine.Events.UnityEvent`1[[System.Boolean, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]
    [JSBindingAttribute]
    public class QuickJS_UnityEngine_Events_UnityEvent_Boolean
    {
        ...
        public static JSValue BindConstructor(JSContext ctx, JSValue new_target, int argc, JSValue[] argv, int magic)
        {
            try
            {
                if (argc == 0)
                {
                    var o = new UnityEngine.Events.UnityEvent<bool>();
        ...
        public static JSValue Bind_AddListener(JSContext ctx, JSValue this_obj, int argc, JSValue[] argv)
        {
            try
            {
                if (argc == 1)
                {
                    UnityEngine.Events.UnityEvent<bool> self;
                    if (!Values.js_get_classvalue(ctx, this_obj, out self))
                    {
                        throw new ThisBoundException();
                    }
                    UnityEngine.Events.UnityAction<bool> arg0;
                    if (!Values.js_get_delegate(ctx, argv[0], out arg0))
                    {
                        throw new ParameterException(typeof(UnityEngine.Events.UnityEvent<bool>), "AddListener", typeof(UnityEngine.Events.UnityAction<bool>), 0);
                    }
        ...
        public static JSValue Bind_RemoveListener(JSContext ctx, JSValue this_obj, int argc, JSValue[] argv)
        {
            try
            {
                if (argc == 1)
                {
                    ...
                    if (!Values.js_get_delegate(ctx, argv[0], out arg0))
                    {
                        throw new ParameterException(typeof(UnityEngine.Events.UnityEvent<bool>), "RemoveListener", typeof(UnityEngine.Events.UnityAction<bool>), 0);
                    }
        ...
        public static JSValue Bind_Invoke(JSContext ctx, JSValue this_obj, int argc, JSValue[] argv)
        {
            try
            {
                if (argc == 1)
                {
                    ...
                    {
                        throw new ParameterException(typeof(UnityEngine.Events.UnityEvent<bool>), "Invoke", typeof(bool), 0);
                    }
                    self.Invoke(arg0);
                    return JSApi.JS_UNDEFINED;
                }
        ...
        {
            var cls = register.CreateClass("UnityEvent_Boolean", typeof(UnityEngine.Events.UnityEvent<bool>), BindConstructor);
