...
namespace jsb {
    ...
    // Type: System.UInt16
    [JSBindingAttribute]
    public class QuickJS_System_UInt16
    {
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(object)))
                        {
                            ...
                            {
                                throw new ParameterException(typeof(ushort), "CompareTo", typeof(object), 0);
                            }
                            var ret = self.CompareTo(arg0);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
                        if (Values.js_match_type(ctx, argv[0], typeof(ushort)))
                        {
                            ushort self;
                            if (!QuickJS.Binding.Values.js_get_primitive(ctx, this_obj, out self))
                            {
                            ...
                            {
                                throw new ParameterException(typeof(ushort), "CompareTo", typeof(ushort), 0);
                            }
                            var ret = self.CompareTo(arg0);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(object)))
                        {
                            ...
                            if (!Values.js_get_var(ctx, argv[0], out arg0))
                            {
                                throw new ParameterException(typeof(ushort), "Equals", typeof(object), 0);
                            }
                        ...
                        if (Values.js_match_type(ctx, argv[0], typeof(ushort)))
                        {
                            ...
                            if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                            {
                                throw new ParameterException(typeof(ushort), "Equals", typeof(ushort), 0);
                            }
                            var ret = self.Equals(arg0);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
            ...
            try
            {
                do
                {
                    if (argc == 2)
                    {
                        ...
                        if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                        {
                            throw new ParameterException(typeof(ushort), "ToString", typeof(string), 0);
                        }
                        System.IFormatProvider arg1;
                        if (!Values.js_get_classvalue(ctx, argv[1], out arg1))
                        {
                            throw new ParameterException(typeof(ushort), "ToString", typeof(System.IFormatProvider), 1);
                        }
                    ...
                    if (argc == 1)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(System.IFormatProvider)))
                        {
                            ...
                            {
                                throw new ParameterException(typeof(ushort), "ToString", typeof(System.IFormatProvider), 0);
                            }
            ...
            try
            {
                do
                {
                    if (argc == 3)
                    {
                        ...
                        if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                        {
                            throw new ParameterException(typeof(ushort), "Parse", typeof(string), 0);
                        }
                        System.Globalization.NumberStyles arg1;
                        if (!Values.js_get_enumvalue(ctx, argv[1], out arg1))
                        {
                            throw new ParameterException(typeof(ushort), "Parse", typeof(System.Globalization.NumberStyles), 1);
                        }
                        System.IFormatProvider arg2;
                        if (!Values.js_get_classvalue(ctx, argv[2], out arg2))
                        {
                            throw new ParameterException(typeof(ushort), "Parse", typeof(System.IFormatProvider), 2);
                        }
                        var ret = ushort.Parse(arg0, arg1, arg2);
                        return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                    }
                    if (argc == 2)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(string)) && Values.js_match_type(ctx, argv[1], typeof(System.Globalization.NumberStyles)))
                        {
                            ...
                            var ret = ushort.Parse(arg0, arg1);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
                        if (Values.js_match_type(ctx, argv[0], typeof(string)) && Values.js_match_type(ctx, argv[1], typeof(System.IFormatProvider)))
                        {
                            ...
                            if (!Values.js_get_classvalue(ctx, argv[1], out arg1))
                            {
                                throw new ParameterException(typeof(ushort), "Parse", typeof(System.IFormatProvider), 1);
                            }
                            var ret = ushort.Parse(arg0, arg1);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
            ...
            try
            {
                do
                {
                    if (argc == 4)
                    {
                        ...
                        if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                        {
                            throw new ParameterException(typeof(ushort), "TryParse", typeof(string), 0);
                        }
                        System.Globalization.NumberStyles arg1;
                        if (!Values.js_get_enumvalue(ctx, argv[1], out arg1))
                        {
                            throw new ParameterException(typeof(ushort), "TryParse", typeof(System.Globalization.NumberStyles), 1);
                        }
                        System.IFormatProvider arg2;
                        if (!Values.js_get_classvalue(ctx, argv[2], out arg2))
                        {
                            throw new ParameterException(typeof(ushort), "TryParse", typeof(System.IFormatProvider), 2);
                        }
                        ushort arg3;
                        var ret = ushort.TryParse(arg0, arg1, arg2, out arg3);
                    ...
                    if (argc == 2)
                    {
                        ...
                        ushort arg1;
                        var ret = ushort.TryParse(arg0, out arg1);
        ...
        {
            var cls = register.CreateClass("UInt16", typeof(ushort), QuickJS.JSNative.class_private_ctor);
            ...
            cls.AddConstValue("MaxValue", 65535);
            cls.AddConstValue("MinValue", 0);
            return cls;
        }
    }
}
