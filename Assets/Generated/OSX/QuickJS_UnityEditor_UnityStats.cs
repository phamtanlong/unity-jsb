...
//         }
//         [MonoPInvokeCallbackAttribute(typeof(QuickJS.Native.JSGetterCFunction))]
//         public static JSValue BindStaticRead_visibleAnimations(JSContext ctx, JSValue this_obj)
//         {
//             try
//             {
//                 var ret = UnityEditor.UnityStats.visibleAnimations;
//                 return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
//             }
//             catch (Exception exception)
//             {
...
//             cls.AddProperty(true, "visibleAnimations", BindStaticRead_visibleAnimations, null);
//             return cls;
//         }
//     }
// }
