...
namespace jsb {
    ...
    // Type: UnityEditor.TerrainTools.IOnPaint
    [JSBindingAttribute]
    public class QuickJS_UnityEditor_TerrainTools_IOnPaint
    {
        ...
        public static JSValue Bind_Repaint(JSContext ctx, JSValue this_obj, int argc, JSValue[] argv)
        {
            try
            {
                if (argc == 1)
                {
                    UnityEditor.TerrainTools.IOnPaint self;
                    ...
                    {
                        throw new ParameterException(typeof(UnityEditor.TerrainTools.IOnPaint), "Repaint", typeof(UnityEditor.TerrainTools.RepaintFlags), 0);
                    }
                    self.Repaint(arg0);
        ...
        {
            var cls = register.CreateClass("IOnPaint", typeof(UnityEditor.TerrainTools.IOnPaint), QuickJS.JSNative.class_private_ctor);
