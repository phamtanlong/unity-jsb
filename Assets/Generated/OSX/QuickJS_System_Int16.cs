...
namespace jsb {
    ...
    // Type: System.Int16
    [JSBindingAttribute]
    public class QuickJS_System_Int16
    {
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(object)))
                        {
                            ...
                            {
                                throw new ParameterException(typeof(short), "CompareTo", typeof(object), 0);
                            }
                            var ret = self.CompareTo(arg0);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
                        if (Values.js_match_type(ctx, argv[0], typeof(short)))
                        {
                            short self;
                            if (!QuickJS.Binding.Values.js_get_primitive(ctx, this_obj, out self))
                            {
                            ...
                            {
                                throw new ParameterException(typeof(short), "CompareTo", typeof(short), 0);
                            }
                            var ret = self.CompareTo(arg0);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(object)))
                        {
                            ...
                            if (!Values.js_get_var(ctx, argv[0], out arg0))
                            {
                                throw new ParameterException(typeof(short), "Equals", typeof(object), 0);
                            }
                        ...
                        if (Values.js_match_type(ctx, argv[0], typeof(short)))
                        {
                            ...
                            if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                            {
                                throw new ParameterException(typeof(short), "Equals", typeof(short), 0);
                            }
                            var ret = self.Equals(arg0);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
            ...
            try
            {
                do
                {
                    if (argc == 2)
                    {
                        ...
                        if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                        {
                            throw new ParameterException(typeof(short), "ToString", typeof(string), 0);
                        }
                        System.IFormatProvider arg1;
                        if (!Values.js_get_classvalue(ctx, argv[1], out arg1))
                        {
                            throw new ParameterException(typeof(short), "ToString", typeof(System.IFormatProvider), 1);
                        }
                    ...
                    if (argc == 1)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(System.IFormatProvider)))
                        {
                            ...
                            {
                                throw new ParameterException(typeof(short), "ToString", typeof(System.IFormatProvider), 0);
                            }
            ...
            try
            {
                do
                {
                    if (argc == 3)
                    {
                        ...
                        if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                        {
                            throw new ParameterException(typeof(short), "Parse", typeof(string), 0);
                        }
                        System.Globalization.NumberStyles arg1;
                        if (!Values.js_get_enumvalue(ctx, argv[1], out arg1))
                        {
                            throw new ParameterException(typeof(short), "Parse", typeof(System.Globalization.NumberStyles), 1);
                        }
                        System.IFormatProvider arg2;
                        if (!Values.js_get_classvalue(ctx, argv[2], out arg2))
                        {
                            throw new ParameterException(typeof(short), "Parse", typeof(System.IFormatProvider), 2);
                        }
                        var ret = short.Parse(arg0, arg1, arg2);
                        return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                    }
                    if (argc == 2)
                    {
                        ...
                        if (Values.js_match_type(ctx, argv[0], typeof(string)) && Values.js_match_type(ctx, argv[1], typeof(System.IFormatProvider)))
                        {
                            ...
                            if (!Values.js_get_classvalue(ctx, argv[1], out arg1))
                            {
                                throw new ParameterException(typeof(short), "Parse", typeof(System.IFormatProvider), 1);
                            }
                            var ret = short.Parse(arg0, arg1);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
            ...
            try
            {
                do
                {
                    if (argc == 4)
                    {
                        ...
                        if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                        {
                            throw new ParameterException(typeof(short), "TryParse", typeof(string), 0);
                        }
                        System.Globalization.NumberStyles arg1;
                        if (!Values.js_get_enumvalue(ctx, argv[1], out arg1))
                        {
                            throw new ParameterException(typeof(short), "TryParse", typeof(System.Globalization.NumberStyles), 1);
                        }
                        System.IFormatProvider arg2;
                        if (!Values.js_get_classvalue(ctx, argv[2], out arg2))
                        {
                            throw new ParameterException(typeof(short), "TryParse", typeof(System.IFormatProvider), 2);
                        }
                        short arg3;
                        var ret = short.TryParse(arg0, arg1, arg2, out arg3);
                    ...
                    if (argc == 2)
                    {
                        ...
                        short arg1;
                        var ret = short.TryParse(arg0, out arg1);
        ...
        {
            var cls = register.CreateClass("Int16", typeof(short), QuickJS.JSNative.class_private_ctor);
            ...
            cls.AddConstValue("MaxValue", 32767);
            cls.AddConstValue("MinValue", -32768);
            return cls;
        }
    }
}
