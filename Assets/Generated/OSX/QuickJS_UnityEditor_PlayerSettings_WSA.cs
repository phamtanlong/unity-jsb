...
//         }
//         [MonoPInvokeCallbackAttribute(typeof(QuickJS.Native.JSGetterCFunction))]
//         public static JSValue BindStaticRead_packageLogo(JSContext ctx, JSValue this_obj)
//         {
//             try
//             {
//                 var ret = UnityEditor.PlayerSettings.WSA.packageLogo;
//                 return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
//             }
//             catch (Exception exception)
//             {
...
//         }
//         [MonoPInvokeCallbackAttribute(typeof(QuickJS.Native.JSSetterCFunction))]
//         public static JSValue BindStaticWrite_packageLogo(JSContext ctx, JSValue this_obj, JSValue arg_val)
//         {
//             try
//             {
//                 string value;
//                 if (!QuickJS.Binding.Values.js_get_primitive(ctx, arg_val, out value))
//                 {
//                     throw new ParameterException(typeof(UnityEditor.PlayerSettings.WSA), "packageLogo", typeof(string), 0);
//                 }
//                 UnityEditor.PlayerSettings.WSA.packageLogo = value;
//                 return JSApi.JS_UNDEFINED;
//             }
//             catch (Exception exception)
//             {
...
//             cls.AddProperty(true, "packageLogo", BindStaticRead_packageLogo, BindStaticWrite_packageLogo);
