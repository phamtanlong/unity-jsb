...
namespace jsb {
    ...
    // Type: System.Int32
    [JSBindingAttribute]
    public class QuickJS_System_Int32
    {
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(object)))
                        {
                            ...
                            {
                                throw new ParameterException(typeof(int), "CompareTo", typeof(object), 0);
                            }
                        ...
                        if (Values.js_match_type(ctx, argv[0], typeof(int)))
                        {
                            ...
                            {
                                throw new ParameterException(typeof(int), "CompareTo", typeof(int), 0);
                            }
                            var ret = self.CompareTo(arg0);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(object)))
                        {
                            ...
                            if (!Values.js_get_var(ctx, argv[0], out arg0))
                            {
                                throw new ParameterException(typeof(int), "Equals", typeof(object), 0);
                            }
                        ...
                        if (Values.js_match_type(ctx, argv[0], typeof(int)))
                        {
                            ...
                            if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                            {
                                throw new ParameterException(typeof(int), "Equals", typeof(int), 0);
                            }
                            var ret = self.Equals(arg0);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
            ...
            try
            {
                do
                {
                    if (argc == 2)
                    {
                        ...
                        if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                        {
                            throw new ParameterException(typeof(int), "ToString", typeof(string), 0);
                        }
                        System.IFormatProvider arg1;
                        if (!Values.js_get_classvalue(ctx, argv[1], out arg1))
                        {
                            throw new ParameterException(typeof(int), "ToString", typeof(System.IFormatProvider), 1);
                        }
                    ...
                    if (argc == 1)
                    {
                        ...
                        if (Values.js_match_type(ctx, argv[0], typeof(System.IFormatProvider)))
                        {
                            ...
                            {
                                throw new ParameterException(typeof(int), "ToString", typeof(System.IFormatProvider), 0);
                            }
                            var ret = self.ToString(arg0);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
            ...
            try
            {
                do
                {
                    if (argc == 3)
                    {
                        ...
                        if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                        {
                            throw new ParameterException(typeof(int), "Parse", typeof(string), 0);
                        }
                        System.Globalization.NumberStyles arg1;
                        if (!Values.js_get_enumvalue(ctx, argv[1], out arg1))
                        {
                            throw new ParameterException(typeof(int), "Parse", typeof(System.Globalization.NumberStyles), 1);
                        }
                        System.IFormatProvider arg2;
                        if (!Values.js_get_classvalue(ctx, argv[2], out arg2))
                        {
                            throw new ParameterException(typeof(int), "Parse", typeof(System.IFormatProvider), 2);
                        }
                    ...
                    if (argc == 2)
                    {
                        ...
                        if (Values.js_match_type(ctx, argv[0], typeof(string)) && Values.js_match_type(ctx, argv[1], typeof(System.IFormatProvider)))
                        {
                            ...
                            if (!Values.js_get_classvalue(ctx, argv[1], out arg1))
                            {
                                throw new ParameterException(typeof(int), "Parse", typeof(System.IFormatProvider), 1);
                            }
                            var ret = int.Parse(arg0, arg1);
                            return QuickJS.Binding.Values.js_push_primitive(ctx, ret);
                        }
            ...
            try
            {
                do
                {
                    if (argc == 4)
                    {
                        ...
                        if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
                        {
                            throw new ParameterException(typeof(int), "TryParse", typeof(string), 0);
                        }
                        System.Globalization.NumberStyles arg1;
                        if (!Values.js_get_enumvalue(ctx, argv[1], out arg1))
                        {
                            throw new ParameterException(typeof(int), "TryParse", typeof(System.Globalization.NumberStyles), 1);
                        }
                        System.IFormatProvider arg2;
                        if (!Values.js_get_classvalue(ctx, argv[2], out arg2))
                        {
                            throw new ParameterException(typeof(int), "TryParse", typeof(System.IFormatProvider), 2);
                        }
                        int arg3;
        ...
        {
            var cls = register.CreateClass("Int32", typeof(int), QuickJS.JSNative.class_private_ctor);
            ...
            cls.AddConstValue("MaxValue", 2147483647);
            cls.AddConstValue("MinValue", -2147483648);
            return cls;
        }
    }
}
