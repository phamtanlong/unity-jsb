...
//         }
//         [MonoPInvokeCallbackAttribute(typeof(QuickJS.Native.JSCFunction))]
//         public static JSValue BindStatic_CompileCSharp(JSContext ctx, JSValue this_obj, int argc, JSValue[] argv)
//         {
//             try
//             {
//                 if (argc == 4)
...
//                     if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[0], out arg0))
//                     {
//                         throw new ParameterException(typeof(UnityEditor.EditorUtility), "CompileCSharp", typeof(string[]), 0);
//                     }
//                     string[] arg1;
//                     if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[1], out arg1))
//                     {
//                         throw new ParameterException(typeof(UnityEditor.EditorUtility), "CompileCSharp", typeof(string[]), 1);
//                     }
//                     string[] arg2;
//                     if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[2], out arg2))
//                     {
//                         throw new ParameterException(typeof(UnityEditor.EditorUtility), "CompileCSharp", typeof(string[]), 2);
//                     }
//                     string arg3;
//                     if (!QuickJS.Binding.Values.js_get_primitive(ctx, argv[3], out arg3))
//                     {
//                         throw new ParameterException(typeof(UnityEditor.EditorUtility), "CompileCSharp", typeof(string), 3);
//                     }
//                     var ret = UnityEditor.EditorUtility.CompileCSharp(arg0, arg1, arg2, arg3);
//                     return Values.js_push_classvalue(ctx, ret);
//                 }
//                 throw new NoSuitableMethodException("CompileCSharp", argc);
//             }
//             catch (Exception exception)
//             {
//                 return JSNative.ThrowException(ctx, exception);
...
//             cls.AddMethod(true, "CompileCSharp", BindStatic_CompileCSharp);
