...
namespace jsb {
    ...
    [JSBindingAttribute]
    public class QuickJS_UnityEngine_UI_IMaskable
    {
        ...
        {
            var cls = register.CreateClass("IMaskable", typeof(UnityEngine.UI.IMaskable), QuickJS.JSNative.class_private_ctor);
