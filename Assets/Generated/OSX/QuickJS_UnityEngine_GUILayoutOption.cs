...
namespace jsb {
    ...
    [JSBindingAttribute]
    public class QuickJS_UnityEngine_GUILayoutOption
    {
        public static QuickJS.Binding.ClassDecl Bind(QuickJS.Binding.TypeRegister register)
        {
            var cls = register.CreateClass("GUILayoutOption", typeof(UnityEngine.GUILayoutOption), QuickJS.JSNative.class_private_ctor);
            return cls;
        }
    }
}
