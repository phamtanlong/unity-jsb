...
namespace jsb {
    ...
    [JSBindingAttribute]
    public class QuickJS_UnityEditor_EditorGUILayout_VerticalScope
    {
                ...
                do
                {
                    if (argc >= 1)
                    {
                        if (Values.js_match_type(ctx, argv[0], typeof(UnityEngine.GUIStyle)) && Values.js_match_param_types(ctx, 1, argv, typeof(UnityEngine.GUILayoutOption)))
                        {
                            ...
                            {
                                throw new ParameterException(typeof(UnityEditor.EditorGUILayout.VerticalScope), ".ctor", typeof(UnityEngine.GUIStyle), 0);
                            }
                            ...
                            var o = new UnityEditor.EditorGUILayout.VerticalScope(arg0, arg1);
                    ...
                    if (Values.js_match_param_types(ctx, 0, argv, typeof(UnityEngine.GUILayoutOption)))
                    {
                        ...
                        var o = new UnityEditor.EditorGUILayout.VerticalScope(arg0);
                        var val = Values.NewBridgeClassObject(ctx, new_target, o, magic, false);
                        return val;
                    }
                } while(false);
        ...
        public static JSValue BindRead_rect(JSContext ctx, JSValue this_obj)
        {
            try
            {
                UnityEditor.EditorGUILayout.VerticalScope self;
        ...
        {
            var cls = register.CreateClass("VerticalScope", typeof(UnityEditor.EditorGUILayout.VerticalScope), BindConstructor);
