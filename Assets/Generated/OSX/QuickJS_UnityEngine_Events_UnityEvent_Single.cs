...
namespace jsb {
    ...
    // Type: UnityEngine.Events.UnityEvent`1[[System.Single, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]
    [JSBindingAttribute]
    public class QuickJS_UnityEngine_Events_UnityEvent_Single
    {
        ...
        public static JSValue BindConstructor(JSContext ctx, JSValue new_target, int argc, JSValue[] argv, int magic)
        {
            try
            {
                if (argc == 0)
                {
                    var o = new UnityEngine.Events.UnityEvent<float>();
        ...
        public static JSValue Bind_AddListener(JSContext ctx, JSValue this_obj, int argc, JSValue[] argv)
        {
            try
            {
                if (argc == 1)
                {
                    UnityEngine.Events.UnityEvent<float> self;
                    if (!Values.js_get_classvalue(ctx, this_obj, out self))
                    {
                        throw new ThisBoundException();
                    }
                    UnityEngine.Events.UnityAction<float> arg0;
                    if (!Values.js_get_delegate(ctx, argv[0], out arg0))
                    {
                        throw new ParameterException(typeof(UnityEngine.Events.UnityEvent<float>), "AddListener", typeof(UnityEngine.Events.UnityAction<float>), 0);
                    }
        ...
        public static JSValue Bind_RemoveListener(JSContext ctx, JSValue this_obj, int argc, JSValue[] argv)
        {
            try
            {
                if (argc == 1)
                {
                    ...
                    if (!Values.js_get_delegate(ctx, argv[0], out arg0))
                    {
                        throw new ParameterException(typeof(UnityEngine.Events.UnityEvent<float>), "RemoveListener", typeof(UnityEngine.Events.UnityAction<float>), 0);
                    }
        ...
        public static JSValue Bind_Invoke(JSContext ctx, JSValue this_obj, int argc, JSValue[] argv)
        {
            try
            {
                if (argc == 1)
                {
                    ...
                    {
                        throw new ParameterException(typeof(UnityEngine.Events.UnityEvent<float>), "Invoke", typeof(float), 0);
                    }
                    self.Invoke(arg0);
                    return JSApi.JS_UNDEFINED;
                }
        ...
        {
            var cls = register.CreateClass("UnityEvent_Single", typeof(UnityEngine.Events.UnityEvent<float>), BindConstructor);
