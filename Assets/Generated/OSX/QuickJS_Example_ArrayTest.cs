...
namespace jsb {
    ...
    // Type: Example.ArrayTest
    [JSBindingAttribute]
    public class QuickJS_Example_ArrayTest
    {
        ...
        public static JSValue BindStaticRead_values1(JSContext ctx, JSValue this_obj)
        {
            try
            {
                var ret = Example.ArrayTest.values1;
        ...
        public static JSValue BindStaticWrite_values1(JSContext ctx, JSValue this_obj, JSValue arg_val)
        {
            try
            {
                ...
                {
                    throw new ParameterException(typeof(Example.ArrayTest), "values1", typeof(int[]), 0);
                }
                Example.ArrayTest.values1 = value;
        ...
        {
            var cls = register.CreateClass("ArrayTest", typeof(Example.ArrayTest), BindConstructor);
