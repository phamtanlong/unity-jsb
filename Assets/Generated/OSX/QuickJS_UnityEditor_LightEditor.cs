...
namespace jsb {
    ...
    [JSBindingAttribute]
    public class QuickJS_UnityEditor_LightEditor
    {
        ...
        public static JSValue BindConstructor(JSContext ctx, JSValue new_target, int argc, JSValue[] argv, int magic)
        {
            try
            {
                if (argc == 0)
                {
                    var o = new UnityEditor.LightEditor();
        ...
        {
            var cls = register.CreateClass("LightEditor", typeof(UnityEditor.LightEditor), BindConstructor);
