    ...
    public class QuickJS_UnityEngine_Events_UnityEvent_BaseEventData
    {
        ...
        public static JSValue BindConstructor(JSContext ctx, JSValue new_target, int argc, JSValue[] argv, int magic)
        {
            try
            {
                if (argc == 0)
                {
                    var o = new UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>();
        ...
        {
            var cls = register.CreateClass("UnityEvent_BaseEventData", typeof(UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>), BindConstructor);
